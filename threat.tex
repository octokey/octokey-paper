...
% Key escrow service rather than printing stuff off? e.g. define a standard API which your bank can
% implement; through that API Octokey can automatically submit private keys to the bank when the
% keys are rotated; to get them out again, you have to show up in person at the bank and show them
% your passport.
